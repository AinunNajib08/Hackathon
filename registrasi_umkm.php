            ...
            <div class="tracking_box_inner">
                ...
                <form class="row tracking_form" action="action/regis.php" method="post" novalidate="novalidate">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="alamat_lengkap" required class="form-control" id="alamat_lengkap" name="alamat_lengkap" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Lengkap'">
                    </div>
                    <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" required class="form-control" id="Password" name="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Lengkap'">
                    </div>
                    <div class="col-md-12 form-group">
                        <label for="namalengkap">Nomor Handphone *</label>
                        <input type="text" required class="form-control" id="no_hp" name="no_hp" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Lengkap'">
                    </div>
                    <div class="col-md-12 form-group">
                        <button type="submit" required value="submit" class="primary-btn" name="daftar">Registrasi</button>
                    </div>
                </form>
            </div>
        </div>
